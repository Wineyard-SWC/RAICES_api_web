...
from routes import bug_router, app_router, user_router, project_router, project_user_router, requirements_router, epic_router, userStorie_router, users_search_router, tasks_router, sprints_router, sprint_details_router, permissions_router, teams_router, user_roles_router # , email_router  #<-- Futuras rutas de la API
